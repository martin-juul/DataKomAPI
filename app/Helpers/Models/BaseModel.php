...
class BaseModel extends Model
{
    ...
    private function getQueryData($params, $defs=['perPage', 'order'=>'asc', 'sort'=>'id']) {
    ...
    private function getTotals($query, $queryData, $sums) {
    ...
    private function addNestedQuery($field, $o, $prefsuf, $s, $value, $query){
        ...
        $query=$query->whereHas($column, function($q) use ($column, $column_value, $value, $o, $prefsuf, $s, $query, $field)
        {
